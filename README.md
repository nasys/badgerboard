...
* [**_Arduino_**](https://www.arduino.cc/en/Main/Software){:target="_blank"}
* [**_Git_**](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git#Installing-on-Mac){:target="_blank"}
...
#### Used libraries
* [FaBoHumidity_HTS221](https://github.com/FaBoPlatform/FaBoHumidity-HTS221-Library){:target="_blank"}
* [LowPower](https://github.com/rocketscream/Low-Power){:target="_blank"}
* [Sodaq_RN2483](https://github.com/SodaqMoja/Sodaq_RN2483){:target="_blank"}
